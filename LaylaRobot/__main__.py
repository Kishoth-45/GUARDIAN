...
PM_START_TEXT = """
Hello, IAM GUARDIAN
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ` /help
Maintained by @sandapodalama ❤
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/team_anticheat_1"),
        InlineKeyboardButton(
            text="ꜰᴇᴅᴇʀᴀᴛɪᴏɴ", url=f"https://t.me/team_anticheat_1"
        ),
    ],
    [
...
Powered by :- [Awesome Bots](t.me/sandapodalama)"""

layla_IMG = "https://telegra.ph/file/756c6b0640d636895fef1.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Hero](t.me/sandapodalama) \
 Supporting isnt always financial! [AwesomeSupport](t.me/sandapodalama) \
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *GUARDIAN*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Awesome Bots @sandapodalama
                 \n❍ Support Group @sandapodalama
                 \n❍ Assistant @@MR_WHITE_I_LOVE_U
                 \nHere is the [💾Repository](https://github.com/mrarunDME/GUARDIAN).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *GUARDIAN*
                 \nHere is the [Source Code](https://github.com/mrarunDME/GUARDIAN) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{sandapodalama}", "Yes I'm alive 😹")
        except Unauthorized:
            LOGGER.warning(
